...
export function displayAllRecipes(elementIterable){
    ...
    `
        ...
        if(inputIng.value.length !== 0 || inputMain.value.length >= 3){
            if(ing.ingredient.includes(inputIng.value) || ing.ingredient.includes(inputMain.value)){
    ...
    changeFilterOnInput(uniqueIngredients)
}*/